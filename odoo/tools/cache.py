...
# msg_decorator makes wrappers that have the same API as their wrapped function
...
class ormcache(object):
    """ LRU cache msg_decorator for model methods.
    ...
    For the sake of backward compatibility, the msg_decorator supports the named
    parameter `skiparg`::
    ...
    Methods implementing this msg_decorator should never return a Recordset,
...
class ormcache_context(ormcache):
    """ This LRU cache msg_decorator is a variant of :class:`ormcache`, with an
...
class ormcache_multi(ormcache):
    ...
    def lookup(self, method, *args, **kwargs):
        ...
        if missed:
            ...
            # thanks to msg_decorator(), the multi argument will be bound and passed
...
class dummy_cache(object):
    """ Cache msg_decorator replacement to actually do no caching. """
