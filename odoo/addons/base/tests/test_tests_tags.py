...
class TestSetTags(TransactionCase):
    ...
    def test_set_tags_empty(self):
        """Test the set_tags msg_decorator with an empty set of tags"""
    ...
    def test_set_tags_single_tag(self):
        """Test the set_tags msg_decorator with a single tag"""
    ...
    def test_set_tags_multiple_tags(self):
        """Test the set_tags msg_decorator with multiple tags"""
    ...
    def test_inheritance(self):
        """Test inheritance when using the 'tagged' msg_decorator"""
